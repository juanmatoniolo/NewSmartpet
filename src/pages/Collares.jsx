...
import CollarImage1 from "../assets/collares/1.jpg";
import CollarImage2 from "../assets/collares/2.jpg";
import CollarImage3 from "../assets/collares/3.jpg";
import CollarImage4 from "../assets/collares/4.jpg";
import CollarImage5 from "../assets/collares/5.jpg";
			...
			<div className="container mt-4">
				...
				<div className="row mt-4">
					{collares.map((collar) => (
						<div
							key={collar.id}
							className="col-md-4 col-xl-3 col-sm-4 col-6 mb-4"
						>
							<div className="card">
								<img
									src={collar.image}
