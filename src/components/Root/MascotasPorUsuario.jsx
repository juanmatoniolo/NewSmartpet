...
import { Dog } from "lucide-react"; // opcional, para ícono
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (!userRes.data || !userRes.data.id) throw new Error("Usuario no encontrado");
    ...
    return (
        <>
            ...
            <div className="container mt-4">
                ...
                {mascotas.length === 0 ? (
                    <div className="alert alert-secondary">Este usuario no tiene mascotas registradas.</div>
                ) : (
                    <div className="row">
                        {mascotas.map(m => (
                                ...
                                <div className="card h-100 shadow-sm">
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">
                                            <strong>Sexo:</strong> {m.sexo == 0 ? "Macho" : "Hembra"}<br />
