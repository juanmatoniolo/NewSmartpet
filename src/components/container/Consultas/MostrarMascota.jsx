          ...
          <>
            <main className="container container-main">
                ...
                <div className="datos-mascota">
                  ...
                  <div className="contenedor-datos-mascota">
                    <img
                      ...
                      alt="Icono de sexo"
                    />
                    <p className="sexo-mascota">{mascota.datosMascotas.sexo}</p>
                  </div>
                  <div className="contenedor-datos-mascota">
                    <img
              ...
              {mascota.datosMascotas.descripcion ? (
                ...
                <section className="descripcion" style={{ display: "none" }}></section>
              )}
              {/* Contactos */}
              <section className="contactos-mascota">
                <h2 className="contacto-a text-center">Contactos</h2>
                <div className="contenedor-contacto-a">
                  ...
                  <div className="redes-sociales">
                    ...
                    >
                      <svg
                        ...
                        height="16"
                        fill="currentColor"
                        className="bi bi-whatsapp iconos-redes"
                        viewBox="0 0 16 16"
                      >
                    ...
                    <button
                      ...
                      onClick={() => handleLlamar(mascota.datosMascotas.telefono1)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                        fill="currentColor"
                        className="bi bi-telephone-outbound-fill iconos-redes"
                        viewBox="0 0 16 16"
                      >
                        <path
                          fillRule="evenodd"
                    ...
                    <button
                      ...
                      onClick={() => handleIg(mascota.datosMascotas.ig1)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
                        height="14"
                        fill="currentColor"
                        className="bi bi-instagram iconos-redes"
                        viewBox="0 0 16 16"
                      >
                ...
                <div className="contenedor-contacto-a">
                  ...
                  <div className="redes-sociales">
                    ...
                    <button
                      className="btn btn-primary llamar-redes"
                      onClick={() => handleLlamar(mascota.datosMascotas.telefono2)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <button
                      className="btn btn-primary ig"
                      onClick={() => handleIg(mascota.datosMascotas.ig2)}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="14"
