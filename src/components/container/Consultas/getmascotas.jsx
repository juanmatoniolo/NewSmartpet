  ...
  return (
    <div>
      {mascota ? (
          ...
          >
            ...
            <Card.Body>
              <Card.Title className="titulo-card">
                {mascota.datosMascotas.nombre || "Debe cargar datos"}
              </Card.Title>
              <Card.Text>
                ...
                <p>
                  {mascota.datosMascotas.lat &&
                    ...
                    <a
                      ...
                      className="link-mapa"
                    >
                      <FaMapMarkerAlt style={{ marginRight: "0.5rem" }} /> Ver
                      en mapa
                    </a>
                  ) : (
              ...
              <Button
                ...
                onClick={handleShowModalMostrar}
              >
                Mostrar Mascota
              </Button>
            </Card.Body>
        ...
        <Card
          className="card-pet skeleton-card"
          style={{
            width: "17rem",
            marginBottom: "20px",
          }}
